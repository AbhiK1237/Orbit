...
from browser_use import Agent, BrowserSession, ChatGoogle, ChatOpenAI, Tools
...
async def main():
	...
	try:
		...
		agent = Agent(
			...
			play ticking away song and skip ads on YouTube and end the session once the song is over.
